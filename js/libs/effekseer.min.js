  ...
  var EffekseerEffect = function () {
    ...
    _createClass(EffekseerContext, [{
      ...
      key: "draw", value: function draw() {
        this._makeContextCurrent(); var program = null; if (this._restorationOfStatesFlag) { program = this.gl.getParameter(gl.CURRENT_PROGRAM); this.contextStates.save(); }
      ...
      key: "beginDraw", value: function beginDraw() {
        if (this._restorationOfStatesFlag) { this.contextStates.save(); }
    ...
    }, { key: "setRestorationOfStatesFlag", value: function setRestorationOfStatesFlag(flag) { this._restorationOfStatesFlag = flag; Core.SetRestorationOfStatesFlag(this.nativeptr, flag); } }]); return EffekseerContext;
  }(); var Effekseer = function () {
